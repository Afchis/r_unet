...
FOLDER_DATA = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/JPEGImages/"
FOLDER_MASK = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/SegmentationClass/"
FOLDER_DATA_VAL = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/JPEGImages/"
FOLDER_MASK_VAL = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/SegmentationClass/"
FOLDER_DATA_TEST = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/JPEGImages/"
FOLDER_MASK_TEST = "/headless/afchi_projects/_data_/VOCdevkit/VOC2012/SegmentationClass/"

FOLDER_DATA_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt", "r").read().split('\n')
FOLDER_MASK_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt", "r").read().split('\n')
FOLDER_DATA_VAL_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/trainval.txt", "r").read().split('\n')
FOLDER_MASK_VAL_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/trainval.txt", "r").read().split('\n')
FOLDER_DATA_TEST_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt", "r").read().split('\n')
FOLDER_MASK_TEST_NAMES = open("/headless/afchi_projects/_data_/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt", "r").read().split('\n')
...
resize = transforms.Resize((INPUT_SIZE, INPUT_SIZE),  interpolation = 0)
...
class TrainVOC2012Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(self.time):
            gif_list.append(transform(Image.open(self.folder_data + self.folder_data_names[idx] + '.jpg').convert('RGB')))
